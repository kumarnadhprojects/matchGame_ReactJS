...
- [Extra Small (Size < 576px) and Small (Size >= 576px) - Match Game](https://assets.ccbp.in/frontend/content/react-js/match-game-sm-output.png)
- [Extra Small (Size < 576px) and Small (Size >= 576px) - Scorecard](https://assets.ccbp.in/frontend/content/react-js/match-game-score-card-sm-output.png)
...
- The timer should start running backward from the **60 sec**
- When a tab item is clicked, then the thumbnails whose category same as the respective tabId should be displayed
...
- The image to be matched in the app should have alt attribute value as **match**
- The thumbnail images in the app should have alt attribute value as **thumbnail**
